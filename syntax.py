...
def main(file_path):
    ...
    block_trans = [54, 55, 85, 86, 87, 88, 89, 10, 11, 18]
    block_trans_with_SMTM = [32, 54, 55, 85, 86, 87, 88, 89, 10, 11, 18]
    T0 = [0, 2, 4, 3, 10, 11, 26]
    T1 = [1]
    T2 = [6, 3, 2, 10, 11, 4, 26]
    T3 = [7, 3, 2, 10, 11, 4, 26]
...
def drive_file_name(file_name):
    import os
    import lexical
    lexical.main(file_name)

    file_name, file_extension = os.path.splitext(file_name)

    new_filename = f"{file_name}.out"

    return main(new_filename)
